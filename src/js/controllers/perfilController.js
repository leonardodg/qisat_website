(function () {
	...
	angular
		.module('QiSatApp')
		.controller('perfilController', ['$scope', '$controller', 'authService', 'Authenticated', 'postmon', 'Config',
			function (scope, $controller, authService, Authenticated, postmon, Config) {
				...
				function init() {
					...
					if (Authenticated) {
						...
						if (!scope.user.picture)
							scope.user.picture = Config.imagens.defaultUser;
